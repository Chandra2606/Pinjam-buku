        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Update Data Pinjam</h2>
                </div>
                ...
                <?php } ?>
                <div class="card-body">
                    <form class="row g-3" action="<?php echo base_url('home/update/' . $post['kdpinjam']) ?>" method="post" name="form1">

                        <div class="col-md-6">
                            <label for="inputteks4" class="form-label">Kode Pinjam</label>
                            <input type="teks" class="form-control" name="kdpinjam" value="<?php echo $post['kdpinjam'] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputteks4" class="form-label">Jumlah Pinjam</label>
                            <input type="teks" class="form-control" name="jumlah" value="<?php echo $post['jumlah'] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputteks4" class="form-label">Nama Peminjam</label>
                            <input type="teks" class="form-control" name="nama" value="<?php echo $post['nama'] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputteks4" class="form-label">Denda Per</label>
                            <input type="teks" class="form-control" name="denda" value="<?php echo $post['denda'] ?>" oninput="hitung()">
                        </div>
                        <div class="col-md-6">
                            <label for="inputteks4" class="form-label">Judul Buku</label>
                            <input type="teks" class="form-control" name="judul" value="<?php echo $post['judul'] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputteks4" class="form-label">Total</label>
                            <input type="teks" class="form-control" name="total" value="<?php echo $post['total'] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputteks4" class="form-label">Harga Pinjam</label>
                            <input type="teks" class="form-control" name="harga" value="<?php echo $post['harga'] ?>">
                        </div>
